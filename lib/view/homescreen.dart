            ...
            child: CommonScaffold(
              ...
              body: SafeArea(
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Add empty space at the bottom to prevent the tray from overlapping content
                  ...
                  // Transfer Method Tray
                  Consumer<TransferProvider>(
                    builder: (context, transferProvider, _) {
                      return AnimatedPositioned(
                        duration: const Duration(milliseconds: 300),
                        curve: Curves.easeOut,
                        bottom: transferProvider.showTray ? 0 : -200,
                        left: 0,
                        right: 0,
